...
namespace test.ViewModel.Patients.PatientVMs
{
    public partial class PatientListVM : BasePagedListVM<Patient_View, PatientSearcher>
    {
        ...
        protected override List<GridAction> InitGridAction()
        {
            ...
            {
                this.MakeAction("Patient", "Generate","生成病例","生成",GridActionParameterTypesEnum.NoId,"Patients",600).SetIconCls("_wtmicon _wtmicon-renminbi"),
                this.MakeAction("Patient", "ChangeStatus","更改状态","更改状态",GridActionParameterTypesEnum.SingleId,"Patients",600).SetIconCls("_wtmicon _wtmicon-wxbsousuotuiguang").SetShowInRow(true).SetBindVisiableColName("aaa").SetPromptMessage("你真的需要修改状态嘛？"),
                this.MakeAction("Login", "Login","test","",GridActionParameterTypesEnum.NoId,null,600).SetOnClickScript("test();"),
                this.MakeStandardAction("Patient", GridActionStandardTypesEnum.Create, Localizer["Sys.Create"],"Patients", dialogWidth: 800).SetMax(),
                this.MakeStandardAction("Patient", GridActionStandardTypesEnum.Edit, Localizer["Sys.Edit"], "Patients", dialogWidth: 800),
                this.MakeStandardAction("Patient", GridActionStandardTypesEnum.Delete, Localizer["Sys.Delete"], "Patients", dialogWidth: 800).SetPromptMessage("是否删除数据？").SetShowDialog(false),
                this.MakeStandardAction("Patient", GridActionStandardTypesEnum.Details, Localizer["Sys.Details"], "Patients", dialogWidth: 800),
                this.MakeStandardAction("Patient", GridActionStandardTypesEnum.BatchEdit, Localizer["Sys.BatchEdit"], "Patients", dialogWidth: 800),
                this.MakeStandardAction("Patient", GridActionStandardTypesEnum.BatchDelete, Localizer["Sys.BatchDelete"], "Patients", dialogWidth: 800),
                this.MakeStandardAction("Patient", GridActionStandardTypesEnum.Import, Localizer["Sys.Import"], "Patients", dialogWidth: 800),
                this.MakeStandardAction("Patient", GridActionStandardTypesEnum.ExportExcel, Localizer["Sys.Export"], "Patients"),
            };
        }
    ...
    public class Patient_Summary
    {
        [Display(Name = "确诊人数")]
        public int QueZhen { get; set; }

        [Display(Name = "死亡人数")]
        public int SiWang { get; set; }

        [Display(Name = "治愈人数")]
        public int ZhiYu { get; set; }
    }
}